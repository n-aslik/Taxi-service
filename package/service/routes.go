...
func Printreport(isresp, isdeletedr, isblocked, isdeletedu bool, price int) (route []models.Reports, err error) {
...
func PrintAllRoutes(isdeleted, isresp bool, price int, uid uint) (route []models.GetRoutes, err error) {
...
func PrintAllRouteByID(isdeleted bool, id, uid uint) (route []models.GetRoutes, err error) {
