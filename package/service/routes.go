...
func PrintAllRoutes(isdeleted, isresp bool, price int) (route []models.GetRoutes, err error) {
...
func PrintAllRouteByID(isdeleted bool, id uint) (route []models.GetRoutes, err error) {
